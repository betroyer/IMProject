...
<div class="app-shell">
  <aside class="sidebar" id="sidebar">
    ...
    <nav id="navigation" aria-label="Main navigation">
      ...
      <button class="nav-item active" data-view="dashboard" data-icon="home">Overview</button>
      <button class="nav-item" data-view="setup" data-icon="check">Setup guide</button>
      <button class="nav-item" data-view="plan" data-icon="plan">Business plan</button>
      <p class="nav-label nav-group">Operations</p>
      <button class="nav-item" data-view="accounting" data-icon="wallet">Accounting</button>
      <button class="nav-item" data-view="payments" data-icon="card">Payments</button>
      <button class="nav-item" data-view="rewards" data-icon="gift">Rewards</button>
      <button class="nav-item" data-view="notifications" data-icon="bell">Announcements</button>
      <button class="nav-item" data-view="content" data-icon="file">Content &amp; guides</button>
      <p class="nav-label nav-group">Administration</p>
      <button class="nav-item" data-view="users" data-icon="users">Team &amp; access</button>
      <button class="nav-item" data-view="performance" data-icon="activity">Usage &amp; health</button>
      <button class="nav-item" data-view="support" data-icon="support">Support</button>
    </nav>
...
<script>window.CURRENT_USER=<?= json_encode($signedInUser, JSON_HEX_TAG|JSON_HEX_AMP|JSON_HEX_APOS|JSON_HEX_QUOT) ?>;</script><script src="assets/app.js"></script>
</body></html>
